...
| Entry references an author             | Write `[[Ashish Vaswani]]` in the YAML `authors_related:` field                        | Click to jump directly to the author profile                                                  |
...
| Concept note links an author           | Write `[[Ashish Vaswani]]` in the concept's body text                                  | Establishes a bidirectional "who proposed this concept" link                                  |
